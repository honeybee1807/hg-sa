export const CATEGORIES = [
  ...
  { name: "Beauty & Hair",        desc: "Hair, nails, skincare & beauty",          icon: "fa-solid fa-scissors",       slug: "beauty-hair",        gradient: "linear-gradient(135deg,#EC4899,#C46EA1)" },
...
export const TOWNS = [
  "Bergville", "Colenso", "Dundee", "Frere", "Greytown",
  "Harrismith", "Ladysmith", "Mooi River", "Pietermaritzburg",
  "Weenen", "Winterton",
];

export const SITE_URL = "https://directory.olideentech.co.za";
