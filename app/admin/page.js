...
async function getAllBusinesses() {
  ...
  const { data } = await db
    .from("businesses")
    .select("id, name, category, custom_category, area, province, street_address, whatsapp, instagram, facebook, description, owner_name, owner_email, logo_url, status, review_note, slug, is_own_business, on_behalf_of_name, on_behalf_of_reason")
